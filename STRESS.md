...
- [ ] Optional: heartbeat lines appear ~every 30 min while Work Assist stays on
...
- [ ] Active Hold (beta) + Focus Lock: Sprint removed; Work Assist may stay in background mode
